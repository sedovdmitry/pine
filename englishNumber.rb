def englishNumber number 
  ...
  # Больше не особых случаев! Больше нет возвратов return!
  ...
  if write > 0
    ...
    # Я велел этому методу вызывать себя, но с параметром "write" вместо
    ...
    # мы сначала вызвали englishNumber c 1999 (т.е. "number" = 1999), 
    # затем в этой точке "write" будет равен 19, а "left" равен 99.
    # Наиболее лениво в этом месте было бы заставить engleshNumber
    # вывести на 'nineteen', а затем мы выведем 'hundred',
  ...
  if write > 0
    if ((write == 1) and (left > 0))
      ...
      # Поскольку мы уже позаботились о цифре для единиц,
